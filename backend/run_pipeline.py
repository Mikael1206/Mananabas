...
What it does, in order:
  ...
  4. For each highlight:
     - Find a subject-centered crop x-position (faces, motion, saliency).
     - Build a .ass caption file for the clip (pop-in animation).
     - ffmpeg: crop to 9:16, grade, Ken Burns zoom, mix BGM/SFX, burn captions.
